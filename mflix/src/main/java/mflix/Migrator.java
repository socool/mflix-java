...
public class Migrator {
  ...
  private static UpdateOneModel<Document> transformRating(Document doc) {
    try {
      String imdbRating = String.valueOf(doc.get("imdb", Document.class).get("rating"));
  ...
  public static void main(String[] args) {
    ...
    String mongoUri = "mongodb+srv://m220student:m220password@mflix-glyel.gcp.mongodb.net/test?retryWrites=true&w=majority";
